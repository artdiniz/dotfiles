...
function _box {
    ...
    local _top_box_char="–"
    local _right_box_char="|"
    local _bottom_box_char="–"
    local _left_box_char="|"

    _clock_wise_set_values "$_box_chars" _top_box_char _right_box_char _bottom_box_char _left_box_char
    ...
    function _apply_line_padding {
        ...
        printf "%b%b%b%b%b" "$_left_box_char" "$_padding_left" "$_text" "$_padding_right" "$_right_box_char"
    }
    ...
    local _box_top_border="$(_repeat_string "$_box_horizontal_borders_size" "$_top_box_char")"
    local _box_bottom_border="$(_repeat_string "$_box_horizontal_borders_size" "$_bottom_box_char")"
