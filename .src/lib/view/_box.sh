. "$_DOTFILES_DIR"/.src/lib/view/__engine/_parse_border_description_syntax.sh
. "$_DOTFILES_DIR"/.src/lib/view/__engine/_repeat_string.sh
. "$_DOTFILES_DIR"/.src/lib/view/__engine/_clock_wise_set_values.sh
