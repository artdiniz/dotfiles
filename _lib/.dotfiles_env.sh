...
. "$_DOTFILES_DIR"/_lib/lib/infra/_grep.sh
...
. "$_DOTFILES_DIR"/_lib/lib/os_detection/is_get_os.sh

# shellcheck source=SCRIPTDIR/lib/file_system/_create_and_write_file.sh
. "$_DOTFILES_DIR"/_lib/lib/file_system/_create_and_write_file.sh

# shellcheck source=SCRIPTDIR/lib/file_system/_parse_to_path_with_tilde.sh
. "$_DOTFILES_DIR"/_lib/lib/file_system/_parse_to_path_with_tilde.sh
